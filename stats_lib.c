...
*Returns:
*            (float) max: value of the dataset
********************************************************/
float maximum(float nums[], int n){           //calculating the maximum
   float max = 0;
   int i;
    for (i=0; i<n; i++){
        if (nums[i]> max){
...
********************************************************/
float minimum(float nums[], int n){              //calculating the minimum
    int  i;
    float min=1000000;
    for (i=0; i<n; i++){
        if (nums[i]<min){
...
*            (int) n:        Number of values in the dataset.
            (float) nums[]:  This is the array of the dataset.
            (int)   i:       Used to increment where in the array the value should be taken.
            (float) sum:      The sum of the all the values in the dataset.
*Returns:
*            (float) ave:      The average of the values in the dataset.
********************************************************/

float mean(float nums[], int n){               //calculating the mean
        int i;
        float  sum=0,ave=0;
...
********************************************************/
float standard_deviation(float nums[], int n){     //calculating the standard deviation
    float s, sd;
